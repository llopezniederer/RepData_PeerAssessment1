...
Now we have observations for `r sprintf("%d", nrow(steps1_day))` days; initially we had observations for `r sprintf("%d", nrow(steps_day))` days.

The new mean number of steps per day is `r sprintf("%.2f", mean1_day)`, the new median is `r sprintf("%.2f", median1_day)`;
